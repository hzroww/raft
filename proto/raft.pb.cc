...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_raft_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::raft::InstallSnapshotArgs, leaderid_),
  PROTOBUF_FIELD_OFFSET(::raft::InstallSnapshotArgs, lastincludedindex_),
  PROTOBUF_FIELD_OFFSET(::raft::InstallSnapshotArgs, lastincludedterm_),
  PROTOBUF_FIELD_OFFSET(::raft::InstallSnapshotArgs, data_),
  PROTOBUF_FIELD_OFFSET(::raft::InstallSnapshotArgs, done_),
  ~0u,  // no _has_bits_
...
::PROTOBUF_NAMESPACE_ID::uint8* AppendEntriesReply::_InternalSerialize(
  ...
  if (this->conflictindex() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(3, this->_internal_conflictindex(), target);
  }

  // int64 conflictTerm = 4;
  if (this->conflictterm() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(4, this->_internal_conflictterm(), target);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* InstallSnapshotArgs::_InternalSerialize(
  ...
  if (this->lastincludedindex() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(3, this->_internal_lastincludedindex(), target);
  }

  // int64 lastIncludedTerm = 4;
  if (this->lastincludedterm() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(4, this->_internal_lastincludedterm(), target);
  }
...
void InstallSnapshotArgs::InternalSwap(InstallSnapshotArgs* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(InstallSnapshotArgs, done_)
      + sizeof(InstallSnapshotArgs::done_)
